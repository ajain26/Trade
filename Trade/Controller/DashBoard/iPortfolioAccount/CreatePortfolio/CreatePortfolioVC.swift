...
class CreatePortfolioVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        dropDownTextField.loadDropdownData(data:["Saving", "Current"], selectedValue:"Saving") { value  in
             print(value)
          }
    ...
    func setBuutonLogin(_ button: UIButton){
        ...
        button.setTitle("Save & Configure", for: .normal)
    }
