//
//  LoginColorContoller.swift
//  Trade
//
//  Created by Anshul on 03/01/20.
//  Copyright © 2020 Apurva. All rights reserved.
//

import UIKit

class RegisterColorContoller {

    
    func initlaizeColorControl(topIcon: UIButton,  txtEmail: UITextField, txtPhoneNumber: UITextField, txtPWD: UITextField , _buttonLogin: UIButton) {
        self.setTextFiledEmail(txtEmail)
        self.setTextPhoneNumber(txtPhoneNumber)
